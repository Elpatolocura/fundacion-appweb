...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'suscribirse',
          path: '/suscribirse',
          builder: (context, params) => const SuscribirseWidget(),
        ),
        FFRoute(
          name: 'inicio',
          path: '/inicio',
        ...
        FFRoute(
          name: 'Inicio_admin',
          path: '/inicioAdmin',
          builder: (context, params) => const InicioAdminWidget(),
        ),
        FFRoute(
          name: 'Detalles',
          path: '/Detalles_Noticia',
          builder: (context, params) => const DetallesWidget(),
        )
